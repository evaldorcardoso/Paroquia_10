  ...
  <div class="container-fluid">
    <div class="card card-stats">
        <div class="card-header card-header-icon">
            ...
            <p class="card-category">{{ formatDate(event.event_at) }}</p>
            <h6 style="color:gray;text-transform: none;font-weight:100">{{ event.congregation ? event.congregation.name : '' }}</h6>
        </div>
